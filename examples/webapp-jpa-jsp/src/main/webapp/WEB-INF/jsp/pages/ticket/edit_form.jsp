    ...
    <h:section name="content">
        ...
        <div class="bug-tracker-container">
            <div class="row center-block">
                <div class="col-xs-12">
                    <div class="row">
                        <h1 class="h1"><h:message key="ticket.update.header">Edit ticket</h:message></h1>
                        <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6">

                            <f:form action="/tickets/update/${ticket.id}" method="post" class="form-horizontal">
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            <label for="ac-addr-salutation" class="col-xs-12 col-sm-6 col-md-6 col-lg-6 control-label">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                                <div id="ticket-assignee">
                                                    <f:select name="ticket.assigneeId" class="form-control">
                                        ...
                                        <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-12 col-sm-4 col-md-4 col-lg-4">
                                                <div id="ticket-reporter">
                                                    <f:select name="ticket.reporterId" class="form-control">
                                                        <f:options values="users" value="id" label="name"/>
                                                    </f:select>
                                                </div>
                                            </div>
                                ...
                                <div class="form-group">
                                    <div class="row">
                                        <div class="col-xs-12">
                                            ...
                                            <div class="col-xs-12 col-sm-6 col-md-6 col-lg-6">
                                                <f:button type="submit" name="update.save" class="btn btn-primary" id="ticket-update-save">
                                                    <h:message key="ticket.update.save">Save</h:message>
                                                </f:button>
                                                <h:url class="btn btn-default" value="/tickets/details/${ticket.id}"><h:message key="ticket.update.cancel">Cancel</h:message></h:url>
                                            </div>
                                        </div>
                                    </div>
                                </div>
