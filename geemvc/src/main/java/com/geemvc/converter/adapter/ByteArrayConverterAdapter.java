...
@Adapter
@Singleton
public class ByteArrayConverterAdapter implements ConverterAdapter<byte[]> {
    @Inject
    ...
    @Override
    public byte[] fromStrings(List<String> values, ConverterContext ctx) {
