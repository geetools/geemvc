...
@Singleton
@Adapter
public class DataParamAdapter implements TypedParamAdapter<Data> {
    ...
    @Override
    public String getName(Data dataParam) {
        return dataParam.value() == null ? dataParam.name() : dataParam.value();
    }

    @Override
    public List<String> getValue(Data paramAnnotation, String paramName, ParamContext paramCtx) {
    ...
    @Override
    public Object getTypedValue(Data paramAnnotation, String paramName, ParamContext paramCtx) {
        ...
        if (!reflectionProvider.isSimpleType(beanClass)) {
            ...
            if (dataAdapter != null) {
                ...
                // current request.
                List<String> idValue = getValue(paramAnnotation, identifier.getKey(), paramCtx);
