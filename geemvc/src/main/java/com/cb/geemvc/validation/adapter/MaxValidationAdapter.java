...
import com.cb.geemvc.validation.AbstractValidator;
...
@Adapter
@Singleton
public class MaxValidationAdapter extends AbstractValidator implements ValidationAdapter<Max> {

    @Override
    public boolean incudeInValidation(Max maxAnnotation, RequestHandler requestHandler, ValidationContext validationCtx) {
        return true;
    }
