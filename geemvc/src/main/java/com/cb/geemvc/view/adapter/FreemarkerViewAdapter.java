...
package com.cb.geemvc.view.adapter;
...
@Singleton
@Adapter
public class FreemarkerViewAdapter implements ViewAdapter {
    protected final static String NAME = "FreemarkerViewAdapter";
    protected final static String FREEMARKER_EXTENSION = ".ftl";
    ...
    public boolean canHandle(String path) {
        return path.endsWith(FREEMARKER_EXTENSION);
    }
