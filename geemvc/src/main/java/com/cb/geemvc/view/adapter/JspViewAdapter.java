...
@Singleton
@Adapter
public class JspViewAdapter implements ViewAdapter {
    protected final static String NAME = "JspViewAdapter";
    protected final static String JSP_EXTENSION = ".jsp";
    ...
    public boolean canHandle(String path) {
        return path.endsWith(JSP_EXTENSION);
    }
