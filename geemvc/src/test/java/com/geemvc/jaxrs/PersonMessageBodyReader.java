...
public class PersonMessageBodyReader implements MessageBodyReader<Person> {
    ...
    public PersonMessageBodyReader() {
    ...
    public PersonMessageBodyReader(@Context Application application, @Context UriInfo uriInfo, @Context HttpHeaders httpHeaders, Object someObject) {

    }

    public PersonMessageBodyReader(@Context Application application) {
